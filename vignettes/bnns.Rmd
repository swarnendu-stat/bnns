...
```{r}
# True responses
test_y_bin <- sample(0:1, 5, replace = TRUE)
...
The `bnns` function offers several advanced options for controlling model fitting:
- `iterations`: Number of iterations for Bayesian sampling.
- `warmup`: Number of warmup iterations.
- `chains`: Number of MCMC chains.
- `adapt_delta`: Target acceptance probability for HMC.
