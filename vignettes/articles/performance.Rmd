...
This article evaluates the performance of the `bnns` package on three datasets from the `mlbench` package:  
...
```{r regression-model}
model_reg <- bnns(
  medv ~ -1 + ., data = BH_train, L = 2,  out_act_fn = 1,
...
measure_bin(PID_test$diabetes, PID_pred)
```
