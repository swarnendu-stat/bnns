...
#> Chain 1:                2.763 seconds (Sampling)
#> Chain 1:                3.515 seconds (Total)
#> Chain 1: 
#> Chain 2: Iteration: 1000 / 1000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 0.632 seconds (Warm-up)
#> Chain 2:                3.099 seconds (Sampling)
#> Chain 2:                3.731 seconds (Total)
#> Chain 2:
```
...
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002099 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 20.99 seconds.
#> Chain 1: Adjust your expectations accordingly!
#> Chain 1: 
#> Chain 1: 
#> Chain 2: 
#> Chain 2: Gradient evaluation took 0.002012 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 20.12 seconds.
#> Chain 2: Adjust your expectations accordingly!
#> Chain 2: 
#> Chain 2: 
#> Chain 1: Iteration:   1 / 1000 [  0%]  (Warmup)
...
#> Chain 1: Iteration: 1000 / 1000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 158.161 seconds (Warm-up)
#> Chain 1:                662.984 seconds (Sampling)
#> Chain 1:                821.145 seconds (Total)
#> Chain 1: 
#> Chain 2: Iteration: 1000 / 1000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 158.925 seconds (Warm-up)
#> Chain 2:                665.675 seconds (Sampling)
#> Chain 2:                824.6 seconds (Total)
#> Chain 2:
```
