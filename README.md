...
#> Installing packages into '/tmp/Rtmp5836Jm/temp_libpath338072b264fc'
#> (as 'lib' is unspecified)
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/RtmpA1Nxlm/remotes3c0e19d00e59/swarnendu-stat-bnns-a676a62/DESCRIPTION’ ... OK
#> * preparing ‘bnns’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
#> * building ‘bnns_0.0.0.9000.tar.gz’
#> Installing package into '/tmp/Rtmp5836Jm/temp_libpath338072b264fc'
#> (as 'lib' is unspecified)
```
...
#>   18 : namespace model3c0e59c7ab6e__namespace {
...
#>   89 : class model3c0e59c7ab6e_ final : public model_base_crtp<model3c0e59c7ab6e_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  110 : public:
#>  111 :   ~model3c0e59c7ab6e_() {}
#>  112 :   model3c0e59c7ab6e_(stan::io::var_context& context__, unsigned int
...
#>  122 :       "model3c0e59c7ab6e__namespace::model3c0e59c7ab6e_";
...
#>  339 :       "model3c0e59c7ab6e__namespace::log_prob";
...
#>  527 :       "model3c0e59c7ab6e__namespace::write_array";
...
#> 1168 : };
#> 1169 : }
#> 1170 : using stan_model = model3c0e59c7ab6e__namespace::model3c0e59c7ab6e_;
#> 1171 : #ifndef USING_R
#> 1172 : // Boilerplate
...
#> 1180 :   return model3c0e59c7ab6e__namespace::profiles__;
#> 1181 : }
#> 1182 : #endif
#> 1183 : #endif
#> 1184 : 
#> 1185 : RCPP_MODULE(stan_fit4model3c0e59c7ab6e__mod) {
#> 1186 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1187 :       "stan_fit4model3c0e59c7ab6e_")
#> 1188 : 
...
#> 1244 : // declarations
#> 1245 : extern "C" {
#> 1246 : SEXP file3c0e24996ade( ) ;
#> 1247 : }
#> 1248 : 
#> 1249 : // definition
#> 1250 : SEXP file3c0e24996ade() {
...
#> COMPILING MODEL 'anon_model' NOW.
#> 
#> STARTING SAMPLER FOR MODEL 'anon_model
#> ' NOW.
#> STARTING SAMPLER FOR MODEL 'anon_model' NOW.
```
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model3c0e4eb6cabe__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
...
#>   85 :   " (in 'anon_model', line 22, column 12 to column 20)",
#>   86 :   " (in 'anon_model', line 23, column 9 to column 10)"};
#>   87 : class model3c0e4eb6cabe_ final : public model_base_crtp<model3c0e4eb6cabe_> {
#>   88 : private:
#>   89 :   int n;
#>   90 :   int m;
#>   91 :   int L;
...
#>  107 : public:
#>  108 :   ~model3c0e4eb6cabe_() {}
#>  109 :   model3c0e4eb6cabe_(stan::io::var_context& context__, unsigned int
...
#>  119 :       "model3c0e4eb6cabe__namespace::model3c0e4eb6cabe_";
...
#>  325 :       "model3c0e4eb6cabe__namespace::log_prob";
...
#>  507 :       "model3c0e4eb6cabe__namespace::write_array";
...
#> 1130 : };
#> 1131 : }
#> 1132 : using stan_model = model3c0e4eb6cabe__namespace::model3c0e4eb6cabe_;
#> 1133 : #ifndef USING_R
#> 1134 : // Boilerplate
...
#> 1142 :   return model3c0e4eb6cabe__namespace::profiles__;
#> 1143 : }
#> 1144 : #endif
#> 1145 : #endif
#> 1146 : 
#> 1147 : RCPP_MODULE(stan_fit4model3c0e4eb6cabe__mod) {
#> 1148 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1149 :       "stan_fit4model3c0e4eb6cabe_")
#> 1150 : 
...
#> 1206 : // declarations
#> 1207 : extern "C" {
#> 1208 : SEXP file3c0e3f01c49c( ) ;
#> 1209 : }
#> 1210 : 
#> 1211 : // definition
#> 1212 : SEXP file3c0e3f01c49c() {
