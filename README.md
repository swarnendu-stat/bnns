...
#> 
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/RtmpgvV5Q7/remotes48b44bfa1ebc/swarnendu-stat-bnns-0016962/DESCRIPTION’ ... OK
#> * preparing ‘bnns’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
#> * building ‘bnns_0.0.0.9000.tar.gz’
#> Installing package into '/tmp/RtmpW93M6f/temp_libpath307148b7ac00'
...
#>   18 : namespace model48b46b43cf8b__namespace {
...
#>   89 : class model48b46b43cf8b_ final : public model_base_crtp<model48b46b43cf8b_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  110 : public:
#>  111 :   ~model48b46b43cf8b_() {}
#>  112 :   model48b46b43cf8b_(stan::io::var_context& context__, unsigned int
...
#>  122 :       "model48b46b43cf8b__namespace::model48b46b43cf8b_";
...
#>  339 :       "model48b46b43cf8b__namespace::log_prob";
...
#>  527 :       "model48b46b43cf8b__namespace::write_array";
...
#> 1168 : };
#> 1169 : }
#> 1170 : using stan_model = model48b46b43cf8b__namespace::model48b46b43cf8b_;
#> 1171 : #ifndef USING_R
#> 1172 : // Boilerplate
...
#> 1180 :   return model48b46b43cf8b__namespace::profiles__;
#> 1181 : }
#> 1182 : #endif
#> 1183 : #endif
#> 1184 : 
#> 1185 : RCPP_MODULE(stan_fit4model48b46b43cf8b__mod) {
#> 1186 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1187 :       "stan_fit4model48b46b43cf8b_")
#> 1188 : 
...
#> 1244 : // declarations
#> 1245 : extern "C" {
#> 1246 : SEXP file48b451d039f9( ) ;
#> 1247 : }
#> 1248 : 
#> 1249 : // definition
#> 1250 : SEXP file48b451d039f9() {
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model48b414b76d38__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
...
#>   85 :   " (in 'anon_model', line 22, column 12 to column 20)",
#>   86 :   " (in 'anon_model', line 23, column 9 to column 10)"};
#>   87 : class model48b414b76d38_ final : public model_base_crtp<model48b414b76d38_> {
#>   88 : private:
#>   89 :   int n;
#>   90 :   int m;
#>   91 :   int L;
...
#>  107 : public:
#>  108 :   ~model48b414b76d38_() {}
#>  109 :   model48b414b76d38_(stan::io::var_context& context__, unsigned int
...
#>  119 :       "model48b414b76d38__namespace::model48b414b76d38_";
...
#>  325 :       "model48b414b76d38__namespace::log_prob";
...
#>  507 :       "model48b414b76d38__namespace::write_array";
...
#> 1130 : };
#> 1131 : }
#> 1132 : using stan_model = model48b414b76d38__namespace::model48b414b76d38_;
#> 1133 : #ifndef USING_R
#> 1134 : // Boilerplate
...
#> 1142 :   return model48b414b76d38__namespace::profiles__;
#> 1143 : }
#> 1144 : #endif
#> 1145 : #endif
#> 1146 : 
#> 1147 : RCPP_MODULE(stan_fit4model48b414b76d38__mod) {
#> 1148 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1149 :       "stan_fit4model48b414b76d38_")
#> 1150 : 
...
#> 1206 : // declarations
#> 1207 : extern "C" {
#> 1208 : SEXP file48b44a106991( ) ;
#> 1209 : }
#> 1210 : 
#> 1211 : // definition
#> 1212 : SEXP file48b44a106991() {
