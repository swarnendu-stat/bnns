...
#> 
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmps6cvwK/remotes1e2c655731f5/swarnendu-stat-bnns-702d66b/DESCRIPTION’ ... OK
#> * preparing ‘bnns’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
#> * building ‘bnns_0.0.0.9000.tar.gz’
#> Installing package into '/tmp/RtmpxVcMwf/temp_libpath11ad5b82055f'
...
#>   18 : namespace model1e2c7d5e21d6__namespace {
...
#>   89 : class model1e2c7d5e21d6_ final : public model_base_crtp<model1e2c7d5e21d6_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  110 : public:
#>  111 :   ~model1e2c7d5e21d6_() {}
#>  112 :   model1e2c7d5e21d6_(stan::io::var_context& context__, unsigned int
...
#>  122 :       "model1e2c7d5e21d6__namespace::model1e2c7d5e21d6_";
...
#>  339 :       "model1e2c7d5e21d6__namespace::log_prob";
...
#>  527 :       "model1e2c7d5e21d6__namespace::write_array";
...
#> 1168 : };
#> 1169 : }
#> 1170 : using stan_model = model1e2c7d5e21d6__namespace::model1e2c7d5e21d6_;
#> 1171 : #ifndef USING_R
#> 1172 : // Boilerplate
...
#> 1180 :   return model1e2c7d5e21d6__namespace::profiles__;
#> 1181 : }
#> 1182 : #endif
#> 1183 : #endif
#> 1184 : 
#> 1185 : RCPP_MODULE(stan_fit4model1e2c7d5e21d6__mod) {
#> 1186 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1187 :       "stan_fit4model1e2c7d5e21d6_")
#> 1188 : 
...
#> 1244 : // declarations
#> 1245 : extern "C" {
#> 1246 : SEXP file1e2c6a949e8b( ) ;
#> 1247 : }
#> 1248 : 
#> 1249 : // definition
#> 1250 : SEXP file1e2c6a949e8b() {
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model1e2c2225adb0__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
...
#>   85 :   " (in 'anon_model', line 22, column 12 to column 20)",
#>   86 :   " (in 'anon_model', line 23, column 9 to column 10)"};
#>   87 : class model1e2c2225adb0_ final : public model_base_crtp<model1e2c2225adb0_> {
#>   88 : private:
#>   89 :   int n;
#>   90 :   int m;
#>   91 :   int L;
...
#>  107 : public:
#>  108 :   ~model1e2c2225adb0_() {}
#>  109 :   model1e2c2225adb0_(stan::io::var_context& context__, unsigned int
...
#>  119 :       "model1e2c2225adb0__namespace::model1e2c2225adb0_";
...
#>  325 :       "model1e2c2225adb0__namespace::log_prob";
...
#>  507 :       "model1e2c2225adb0__namespace::write_array";
...
#> 1130 : };
#> 1131 : }
#> 1132 : using stan_model = model1e2c2225adb0__namespace::model1e2c2225adb0_;
#> 1133 : #ifndef USING_R
#> 1134 : // Boilerplate
...
#> 1142 :   return model1e2c2225adb0__namespace::profiles__;
#> 1143 : }
#> 1144 : #endif
#> 1145 : #endif
#> 1146 : 
#> 1147 : RCPP_MODULE(stan_fit4model1e2c2225adb0__mod) {
#> 1148 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1149 :       "stan_fit4model1e2c2225adb0_")
#> 1150 : 
...
#> 1206 : // declarations
#> 1207 : extern "C" {
#> 1208 : SEXP file1e2c2f54d3a2( ) ;
#> 1209 : }
#> 1210 : 
#> 1211 : // definition
#> 1212 : SEXP file1e2c2f54d3a2() {
