...
#> 
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/RtmpT4WTuO/remotes31a6738c3196/swarnendu-stat-bnns-845c57b/DESCRIPTION’ ... OK
#> * preparing ‘bnns’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
#> * building ‘bnns_0.0.0.9000.tar.gz’
#> Installing package into '/tmp/Rtmpezcmqo/temp_libpathb4352ba9350'
...
#>   18 : namespace model31a663dc3b80__namespace {
...
#>   89 : class model31a663dc3b80_ final : public model_base_crtp<model31a663dc3b80_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  110 : public:
#>  111 :   ~model31a663dc3b80_() {}
#>  112 :   model31a663dc3b80_(stan::io::var_context& context__, unsigned int
...
#>  122 :       "model31a663dc3b80__namespace::model31a663dc3b80_";
...
#>  339 :       "model31a663dc3b80__namespace::log_prob";
...
#>  532 :       "model31a663dc3b80__namespace::write_array";
...
#> 1173 : };
#> 1174 : }
#> 1175 : using stan_model = model31a663dc3b80__namespace::model31a663dc3b80_;
#> 1176 : #ifndef USING_R
#> 1177 : // Boilerplate
...
#> 1185 :   return model31a663dc3b80__namespace::profiles__;
#> 1186 : }
#> 1187 : #endif
#> 1188 : #endif
#> 1189 : 
#> 1190 : RCPP_MODULE(stan_fit4model31a663dc3b80__mod) {
#> 1191 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1192 :       "stan_fit4model31a663dc3b80_")
#> 1193 : 
...
#> 1249 : // declarations
#> 1250 : extern "C" {
#> 1251 : SEXP file31a6176744a8( ) ;
#> 1252 : }
#> 1253 : 
#> 1254 : // definition
#> 1255 : SEXP file31a6176744a8() {
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model31a679669c91__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
#>   22 : static constexpr std::array<const char*, 66> locations_array__ =
...
#>   87 :   " (in 'anon_model', line 23, column 12 to column 20)",
#>   88 :   " (in 'anon_model', line 24, column 9 to column 10)"};
#>   89 : class model31a679669c91_ final : public model_base_crtp<model31a679669c91_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  109 :   Eigen::Map<Eigen::Matrix<double,-1,1>> y{nullptr, 0};
#>  110 : public:
#>  111 :   ~model31a679669c91_() {}
#>  112 :   model31a679669c91_(stan::io::var_context& context__, unsigned int
#>  113 :                      random_seed__ = 0, std::ostream* pstream__ = nullptr)
#>  114 :       : model_base_crtp(0) {
#>  115 :     int current_statement__ = 0;
#>  116 :     using local_scalar_t__ = double;
...
#>  120 :     (void) base_rng__;
#>  121 :     static constexpr const char* function__ =
#>  122 :       "model31a679669c91__namespace::model31a679669c91_";
#>  123 :     // suppress unused var warning
#>  124 :     (void) function__;
#>  125 :     local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
#>  126 :     // suppress unused var warning
...
#>  337 :     (void) DUMMY_VAR__;
#>  338 :     static constexpr const char* function__ =
#>  339 :       "model31a679669c91__namespace::log_prob";
#>  340 :     // suppress unused var warning
#>  341 :     (void) function__;
#>  342 :     try {
#>  343 :       Eigen::Matrix<local_scalar_t__,-1,-1> w1 =
...
#>  530 :     constexpr bool jacobian__ = false;
#>  531 :     static constexpr const char* function__ =
#>  532 :       "model31a679669c91__namespace::write_array";
#>  533 :     // suppress unused var warning
#>  534 :     (void) function__;
#>  535 :     try {
#>  536 :       Eigen::Matrix<double,-1,-1> w1 =
...
#> 1173 : };
#> 1174 : }
#> 1175 : using stan_model = model31a679669c91__namespace::model31a679669c91_;
#> 1176 : #ifndef USING_R
#> 1177 : // Boilerplate
#> 1178 : stan::model::model_base&
#> 1179 : new_model(stan::io::var_context& data_context, unsigned int seed,
...
#> 1183 : }
#> 1184 : stan::math::profile_map& get_stan_profile_data() {
#> 1185 :   return model31a679669c91__namespace::profiles__;
#> 1186 : }
#> 1187 : #endif
#> 1188 : #endif
#> 1189 : 
#> 1190 : RCPP_MODULE(stan_fit4model31a679669c91__mod) {
#> 1191 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1192 :       "stan_fit4model31a679669c91_")
#> 1193 : 
#> 1194 :       .constructor<SEXP, SEXP, SEXP>()
#> 1195 : 
#> 1196 :       .method(
...
#> 1249 : // declarations
#> 1250 : extern "C" {
#> 1251 : SEXP file31a66c1771e7( ) ;
#> 1252 : }
#> 1253 : 
#> 1254 : // definition
#> 1255 : SEXP file31a66c1771e7() {
#> 1256 :  return Rcpp::wrap("anon_model");
#> 1257 : }
#> 
#> CHECKING DATA AND PREPROCESSING FOR MODEL 'anon_model' NOW.
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model31a626792b0f__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
...
#>   85 :   " (in 'anon_model', line 22, column 12 to column 20)",
#>   86 :   " (in 'anon_model', line 23, column 9 to column 10)"};
#>   87 : class model31a626792b0f_ final : public model_base_crtp<model31a626792b0f_> {
#>   88 : private:
#>   89 :   int n;
#>   90 :   int m;
#>   91 :   int L;
...
#>  107 : public:
#>  108 :   ~model31a626792b0f_() {}
#>  109 :   model31a626792b0f_(stan::io::var_context& context__, unsigned int
...
#>  119 :       "model31a626792b0f__namespace::model31a626792b0f_";
...
#>  325 :       "model31a626792b0f__namespace::log_prob";
...
#>  511 :       "model31a626792b0f__namespace::write_array";
...
#> 1134 : };
#> 1135 : }
#> 1136 : using stan_model = model31a626792b0f__namespace::model31a626792b0f_;
#> 1137 : #ifndef USING_R
#> 1138 : // Boilerplate
...
#> 1146 :   return model31a626792b0f__namespace::profiles__;
#> 1147 : }
#> 1148 : #endif
#> 1149 : #endif
#> 1150 : 
#> 1151 : RCPP_MODULE(stan_fit4model31a626792b0f__mod) {
#> 1152 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1153 :       "stan_fit4model31a626792b0f_")
#> 1154 : 
...
#> 1210 : // declarations
#> 1211 : extern "C" {
#> 1212 : SEXP file31a6c3e904d( ) ;
#> 1213 : }
#> 1214 : 
#> 1215 : // definition
#> 1216 : SEXP file31a6c3e904d() {
