...
#> 
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/RtmpoFx6NF/remotes3e8c390a41e8/swarnendu-stat-bnns-72079dd/DESCRIPTION’ ... OK
#> * preparing ‘bnns’:
#> * checking DESCRIPTION meta-information ... OK
#> * checking for LF line-endings in source and make files and shell scripts
#> * checking for empty or unneeded directories
#> * building ‘bnns_0.0.0.9000.tar.gz’
#> Installing package into '/tmp/RtmpzIYroh/temp_libpath11571ed94c73'
...
#>   18 : namespace model3e8c70f3729b__namespace {
...
#>   89 : class model3e8c70f3729b_ final : public model_base_crtp<model3e8c70f3729b_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  110 : public:
#>  111 :   ~model3e8c70f3729b_() {}
#>  112 :   model3e8c70f3729b_(stan::io::var_context& context__, unsigned int
...
#>  122 :       "model3e8c70f3729b__namespace::model3e8c70f3729b_";
...
#>  339 :       "model3e8c70f3729b__namespace::log_prob";
...
#>  532 :       "model3e8c70f3729b__namespace::write_array";
...
#> 1173 : };
#> 1174 : }
#> 1175 : using stan_model = model3e8c70f3729b__namespace::model3e8c70f3729b_;
#> 1176 : #ifndef USING_R
#> 1177 : // Boilerplate
...
#> 1185 :   return model3e8c70f3729b__namespace::profiles__;
#> 1186 : }
#> 1187 : #endif
#> 1188 : #endif
#> 1189 : 
#> 1190 : RCPP_MODULE(stan_fit4model3e8c70f3729b__mod) {
#> 1191 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1192 :       "stan_fit4model3e8c70f3729b_")
#> 1193 : 
...
#> 1249 : // declarations
#> 1250 : extern "C" {
#> 1251 : SEXP file3e8c42312711( ) ;
#> 1252 : }
#> 1253 : 
#> 1254 : // definition
#> 1255 : SEXP file3e8c42312711() {
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model3e8c6c27526e__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
#>   22 : static constexpr std::array<const char*, 66> locations_array__ =
...
#>   87 :   " (in 'anon_model', line 23, column 12 to column 20)",
#>   88 :   " (in 'anon_model', line 24, column 9 to column 10)"};
#>   89 : class model3e8c6c27526e_ final : public model_base_crtp<model3e8c6c27526e_> {
#>   90 : private:
#>   91 :   int n;
#>   92 :   int m;
#>   93 :   int L;
...
#>  109 :   Eigen::Map<Eigen::Matrix<double,-1,1>> y{nullptr, 0};
#>  110 : public:
#>  111 :   ~model3e8c6c27526e_() {}
#>  112 :   model3e8c6c27526e_(stan::io::var_context& context__, unsigned int
#>  113 :                      random_seed__ = 0, std::ostream* pstream__ = nullptr)
#>  114 :       : model_base_crtp(0) {
#>  115 :     int current_statement__ = 0;
#>  116 :     using local_scalar_t__ = double;
...
#>  120 :     (void) base_rng__;
#>  121 :     static constexpr const char* function__ =
#>  122 :       "model3e8c6c27526e__namespace::model3e8c6c27526e_";
#>  123 :     // suppress unused var warning
#>  124 :     (void) function__;
#>  125 :     local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
#>  126 :     // suppress unused var warning
...
#>  337 :     (void) DUMMY_VAR__;
#>  338 :     static constexpr const char* function__ =
#>  339 :       "model3e8c6c27526e__namespace::log_prob";
#>  340 :     // suppress unused var warning
#>  341 :     (void) function__;
#>  342 :     try {
#>  343 :       Eigen::Matrix<local_scalar_t__,-1,-1> w1 =
...
#>  530 :     constexpr bool jacobian__ = false;
#>  531 :     static constexpr const char* function__ =
#>  532 :       "model3e8c6c27526e__namespace::write_array";
#>  533 :     // suppress unused var warning
#>  534 :     (void) function__;
#>  535 :     try {
#>  536 :       Eigen::Matrix<double,-1,-1> w1 =
...
#> 1173 : };
#> 1174 : }
#> 1175 : using stan_model = model3e8c6c27526e__namespace::model3e8c6c27526e_;
#> 1176 : #ifndef USING_R
#> 1177 : // Boilerplate
#> 1178 : stan::model::model_base&
#> 1179 : new_model(stan::io::var_context& data_context, unsigned int seed,
...
#> 1183 : }
#> 1184 : stan::math::profile_map& get_stan_profile_data() {
#> 1185 :   return model3e8c6c27526e__namespace::profiles__;
#> 1186 : }
#> 1187 : #endif
#> 1188 : #endif
#> 1189 : 
#> 1190 : RCPP_MODULE(stan_fit4model3e8c6c27526e__mod) {
#> 1191 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1192 :       "stan_fit4model3e8c6c27526e_")
#> 1193 : 
#> 1194 :       .constructor<SEXP, SEXP, SEXP>()
#> 1195 : 
#> 1196 :       .method(
...
#> 1249 : // declarations
#> 1250 : extern "C" {
#> 1251 : SEXP file3e8c42316412( ) ;
#> 1252 : }
#> 1253 : 
#> 1254 : // definition
#> 1255 : SEXP file3e8c42316412() {
#> 1256 :  return Rcpp::wrap("anon_model");
#> 1257 : }
#> 
#> CHECKING DATA AND PREPROCESSING FOR MODEL 'anon_model' NOW.
...
#>   16 : // Code generated by stanc v2.32.2
#>   17 : #include <stan/model/model_header.hpp>
#>   18 : namespace model3e8c7b44ddf4__namespace {
#>   19 : using stan::model::model_base_crtp;
#>   20 : using namespace stan::math;
#>   21 : stan::math::profile_map profiles__;
...
#>   85 :   " (in 'anon_model', line 22, column 12 to column 20)",
#>   86 :   " (in 'anon_model', line 23, column 9 to column 10)"};
#>   87 : class model3e8c7b44ddf4_ final : public model_base_crtp<model3e8c7b44ddf4_> {
#>   88 : private:
#>   89 :   int n;
#>   90 :   int m;
#>   91 :   int L;
...
#>  107 : public:
#>  108 :   ~model3e8c7b44ddf4_() {}
#>  109 :   model3e8c7b44ddf4_(stan::io::var_context& context__, unsigned int
...
#>  119 :       "model3e8c7b44ddf4__namespace::model3e8c7b44ddf4_";
...
#>  325 :       "model3e8c7b44ddf4__namespace::log_prob";
...
#>  511 :       "model3e8c7b44ddf4__namespace::write_array";
...
#> 1134 : };
#> 1135 : }
#> 1136 : using stan_model = model3e8c7b44ddf4__namespace::model3e8c7b44ddf4_;
#> 1137 : #ifndef USING_R
#> 1138 : // Boilerplate
...
#> 1146 :   return model3e8c7b44ddf4__namespace::profiles__;
#> 1147 : }
#> 1148 : #endif
#> 1149 : #endif
#> 1150 : 
#> 1151 : RCPP_MODULE(stan_fit4model3e8c7b44ddf4__mod) {
#> 1152 :   class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >(
#> 1153 :       "stan_fit4model3e8c7b44ddf4_")
#> 1154 : 
...
#> 1210 : // declarations
#> 1211 : extern "C" {
#> 1212 : SEXP file3e8c35fd73a4( ) ;
#> 1213 : }
#> 1214 : 
#> 1215 : // definition
#> 1216 : SEXP file3e8c35fd73a4() {
